...
import com.nemanja.springbootmongodb.springbootmongodb.repository.PersonRepository;
...
public class PersonServiceImpl implements PersonService {
    ...
    public List<Person> findByName(String name) {
        return  repository.findById(name).stream().toList();
    }
    ...
    public List<Person> getByPersonAge(Integer minAge, Integer maxAge) {
        return repository.getByPersonAge(minAge, maxAge);
    }
    ...
    public Page<Person> search(String name, Integer minAge, Integer maxAge, String city, Pageable pageable) {
        ...
        Page<Person> people= null;//PageableExecutionUtils.getPage(template.find(Person.class,pageable,()->template.count(query.skip(0).limit(0),Person.class)));
        return people;
    }
    ...
    public List<Document> getOldestPersonByCity() {
        ...
        Aggregation aggregation= Aggregation.newAggregation(unwindOperation,sort,groupOperation);
    ...
    public List<Document> getPopulationByCity() {
        ...
        ProjectionOperation projectionOperation = Aggregation.project().andExpression("_id").as("city").andExpression("popCount")
                .as("count").andExclude("_id");
